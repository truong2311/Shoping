        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold" style="text-align: center;">TLShop</h1>
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{URL::to('/trang-chu')}}" class="nav-item nav-link">Trang chủ</a>
...
{{--                             <a href="{{URL::to('/shop-detail')}}" class="nav-item nav-link">Shop Detail</a>
 --}}                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="{{URL::to('/show-cart')}}" class="dropdown-item">Shopping Cart</a>
